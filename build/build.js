...
},{"./buffers/default":2,"./buffers/instant":3,"./dataHandlers/column":6,"./dataObject/dataObject":7,"./optionObject/optionObject":10,"./renderers/svg/index":14,"./utils":15}],5:[function(require,module,exports){
"use strict";
...
},{"../utils":15,"./basic":5}],7:[function(require,module,exports){
"use strict";
...
var DataObject = (function (_Obj) {
    ...
    _createClass(DataObject, [{
        ...
        value: function setValuesToColumn(id, values) {
            if (typeof id !== "string") {
                throw new TypeError("Column id should be string and not " + (typeof id === "undefined" ? "undefined" : _typeof(id)));
            }

            if (!Array.isArray(values)) {
                throw new TypeError("Values should be string and not " + (typeof values === "undefined" ? "undefined" : _typeof(values)));
            }

            var column = this.getColumnById(id);

            var offset = this.__getNextX(id);
        ...
        key: "setValueToColumn",
        value: function setValueToColumn(id, value) {
        ...
        value: function emptyColumn(id) {
            ...
            (0, _utils.throwIfNotString)("Column id", id);
        ...
        value: function addRows(rows) {
            ...
            if (!(0, _utils.isArray)(rows)) {
                throw new TypeError("Rows should be array and not " + (typeof rows === "undefined" ? "undefined" : _typeof(rows)));
            }
        ...
        value: function addRow(row) {
            ...
            if (!(0, _utils.isArray)(row.values)) {
                throw new TypeError("Row values should be array and not " + _typeof(row.values));
            }

            row.values.forEach(function (value) {
                _this4.setValueToRow(row.x, value);
            });
        }
    }, {
        key: "setValueToRow",
        value: function setValueToRow(x, value) {
            var __ = this.__;
            ...
            try {
                for (var _iterator3 = __.table[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
...
},{"../object":9,"../utils":15}],8:[function(require,module,exports){
"use strict";
...
},{"./buffers/default":2,"./chart":4,"./dataObject/dataObject":7,"./optionObject/optionObject":10}],9:[function(require,module,exports){
"use strict";
...
},{"../object":9,"../utils":15,"./size":11}],11:[function(require,module,exports){
"use strict";
...
},{"../object":9}],12:[function(require,module,exports){
"use strict";
...
},{"../renderObject":12}],14:[function(require,module,exports){
"use strict";
...
var SvgRenderer = (function (_Renderer) {
    ...
    function SvgRenderer(chart) {
        ...
        _this.easel = _d2.default.select("#chart");

        _this.easel.append("g").attr("transform", "translate(0, 0)");

        _this.color = _d2.default.scale.ordinal().range(["#98abc5", "#8a89a6", "#7b6888", "#6b486b", "#a05d56", "#d0743c", "#ff8c00"]);
        return _this;
    }
    ...
    _createClass(SvgRenderer, [{
        ...
        value: function setSizes() {
            ...
            var x0 = this.x0 = _d2.default.scale.ordinal().rangeRoundBands([0, this.option.size.width], 0.1);
            this.x1 = _d2.default.scale.ordinal().rangeRoundBands([0, x0.rangeBand()]);
        ...
        value: function redrawColumns() {
            ...
            x0.domain(columns.map(function (column) {
                return column.id;
            }));
            ...
            var column = easel.selectAll(".column").data(columns).enter().append("g").attr("class", "column").attr("transform", function (d) {
                return "translate(" + x0(d.id) + ",0)";
            });

            column.selectAll("rect").data(function (d) {
                return d.values;
...
},{"../renderer":13,"d3":16,"underscore":1}],15:[function(require,module,exports){
"use strict";
...
},{"underscore":1}],16:[function(require,module,exports){
!function() {
  var d3 = {
    version: "3.5.6"
  };
