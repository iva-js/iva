(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.iva = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
//     Underscore.js 1.8.3
...
},{"./default":2}],4:[function(require,module,exports){
"use strict";
...
var _column = require("./dataHandlers/column");
...
var _index = require("./renderers/svg/index");

var _index2 = _interopRequireDefault(_index);

var _optionObject = require("./optionObject/optionObject");
...
var Chart = (function () {
    ...
    _createClass(Chart, [{
        ...
        value: function setHandler(handler) {
            handler = (0, _utils.option)(handler, "column");
...
},{"./buffers/default":2,"./buffers/instant":3,"./dataHandlers/column":6,"./dataObject/dataObject":9,"./optionObject/optionObject":12,"./renderers/svg/index":16,"./utils":17}],5:[function(require,module,exports){
"use strict";
...
var ColumnHandler = (function (_Handler) {
    ...
    _createClass(ColumnHandler, [{
        ...
        key: "copyValue",
        value: function copyValue(v, d) {
            d = (0, _utils.option)(d, {});

            return {
                x: v.x,
                y: (0, _utils.option)(v.y, d.y),
                dirty: v.dirty,
                label: v.label
            };
        }
...
},{"../utils":17,"./basic":5}],7:[function(require,module,exports){
"use strict";
...
var Column = (function (_Obj) {
    _inherits(Column, _Obj);

    function Column(d, parent) {
        ...
        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Column).call(this, d, parent));

        _this.values(d.values);
        return _this;
    }
    ...
    _createClass(Column, [{
        ...
        value: function values(_values) {
            ...
            if (!Array.isArray(_values)) {
                throw new Error("d.values should be array and not " + _typeof(d.values));
            }
            __.values = [];
            this.pushValues(_values);
        }
    }, {
        key: "pushValues",
        ...
        key: "popValues",
        value: function popValues(amount) {
            var __ = this.__;

            if (amount === undefined) {
                amount = 0;
            }
            if (!(0, _utils.isNumeric)(amount)) {
        ...
        key: "value",
        value: function value(i, _value) {
            var __ = this.__;

            if (i === undefined) {
                throw new Error("You should provied index for " + _value);
            }
            if (_value === undefined) {
                return __.values[i];
            }
        ...
        key: "createValue",
        value: function createValue(value) {
            ...
            throw new Error("Value should be either object or nubmer but not " + (typeof value === "undefined" ? "undefined" : _typeof(value)));
        }
    }]);
...
},{"../object":11,"../utils":17}],8:[function(require,module,exports){
"use strict";
...
var Columns = (function (_Obj) {
    _inherits(Columns, _Obj);

    function Columns(d, parent) {
        _classCallCheck(this, Columns);

        d = (0, _utils.option)(d, {});
        var values = (0, _utils.option)(d.values, []);

        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Columns).call(this, d, parent));
    ...
    _createClass(Columns, [{
        ...
        value: function pushValues(values) {
            ...
            if (!Array.isArray(values)) {
                throw new Error("Columns should be array and not " + (typeof values === "undefined" ? "undefined" : _typeof(values)));
            }

            values.forEach(function (value) {
                __.values.push(new _column2.default(value, _this2));
            });
...
},{"../object":11,"../utils":17,"./column":7}],9:[function(require,module,exports){
"use strict";
...
var DataObject = (function (_Obj) {
    ...
    function DataObject(d, parent) {
        ...
        _this.columns = new _columns2.default({
            values: d.columns
        }, _this);
        return _this;
    }
...
},{"../object":11,"../utils":17,"./columns":8}],10:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.buffers = exports.Chart = exports.OptionObject = exports.DataObject = undefined;
...
var buffers = {
    DefaultBuffer: _default2.default
};
...
},{"./buffers/default":2,"./chart":4,"./dataObject/dataObject":9,"./optionObject/optionObject":12}],11:[function(require,module,exports){
"use strict";
...
},{"../object":11,"../utils":17,"./size":13}],13:[function(require,module,exports){
"use strict";
...
},{"../object":11}],14:[function(require,module,exports){
"use strict";
...
},{"../renderObject":14}],16:[function(require,module,exports){
"use strict";
...
var SvgRenderer = (function (_Renderer) {
    ...
    function SvgRenderer(chart) {
        ...
        _this.easel = _d2.default.select(bindTo);

        _this.easel.append("g").attr("transform", "translate(0, 0)");

        _this.x = _d2.default.scale.ordinal().rangeRoundBands([0, _this.option.width], 0.1);
        _this.y = _d2.default.scale.linear().range([_this.option.height, 0]);
        return _this;
    }
    ...
    _createClass(SvgRenderer, [{
        ...
        value: function redrawColumns() {
            ...
            this.x.domain(this.data.columns[0].values.map(function (d) {
                return d.x;
            }));
            this.y.domain([0, _d2.default.max(this.data.columns[0].values, function (d) {
                return d.y;
            })]);

            this.easel.selectAll(".bar").data(this.data.columns[0].values).enter().append("rect").attr("class", ".bar").attr("x", function (d) {
                return _this2.x(d.x);
            }).attr("y", function (d) {
                return _this2.y(d.y);
            }).attr("height", function (d) {
                return _this2.option.height - _this2.y(d.y);
...
},{"../renderer":15,"d3":18}],17:[function(require,module,exports){
"use strict";
...
},{"underscore":1}],18:[function(require,module,exports){
!function() {
  var d3 = {
    version: "3.5.6"
  };
